...
<script nonce="${sNonce}">
  ...
  function fToFrame(type){ try{ f.contentWindow.postMessage({source:'mcsv-host', type}, '*'); }catch(_){} }
  ...
  document.getElementById('idReload').onclick = () => fToFrame('reloadPage');
  ...
  window.addEventListener('message', (e) => {
    ...
    if (d.source === 'mcsv-host') {
      ...
      if (d.type === 'reload') { fToFrame('reloadPage'); return; }
